...
UI=""; [ -f "$ROOT/dist/$MODULE_ID/ui.js" ] && UI="$ROOT/dist/$MODULE_ID/ui.js"
scp "$ROOT/dist/$MODULE_ID/dsp.so" "$ROOT/dist/$MODULE_ID/module.json" $HELP $UI "ableton@$MOVE_HOST:$DEST/"
