...
static const preset_t PRESETS[] = {
 ...
 {"Sci-Fi Sweep", 3, 1, 2, 1, -0.20f, 2, 1, 0.12f, 1, 0.75f, 0.65f, 0.0f, 0, 0, 0.12f, 0.85f, 0.75f, 0.60f, 0.65f, 0.30f, 1, 0.10f, 0.60f, 0.90f, 1, 0, 0, 0, 0, 0.06f, 0, 0.0f, 0.45f, 0, 4, 0, 0.00f, 0.72f},
